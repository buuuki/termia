...
SESSION_SNAPSHOT_FILE = STATE_DIR / "termia" / "last-session.json"
...
DEFAULT_SPLIT_SEPARATOR_COLOR = "#008712"
DEFAULT_SPLIT_SEPARATOR_THICKNESS = 1
MAX_SPLIT_SEPARATOR_THICKNESS = 32
