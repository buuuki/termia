...
TRANSLATIONS = {
    "es": {
        ...
        "read_only_mode_enabled": "Esta instancia de Termia está en modo solo lectura porque otra instancia ya tiene el bloqueo de escritura.",
        "read_only_mode_tooltip": "Desactivado mientras otra instancia de Termia tenga el bloqueo de escritura.",
        ...
        "keybindings_description": "Haz clic en un atajo y pulsa la combinación que quieras. Usa Borrar para dejarlo desactivado y que la combinación llegue al shell remoto.",
        "keybinding_capture_prompt": "Pulsa la combinación",
        "keybinding_clear": "Borrar",
    ...
    "ca": {
        ...
        "read_only_badge": "Només lectura",
        "read_only_mode_enabled": "Aquesta instància de Termia està en mode només lectura perquè una altra instància ja té el bloqueig d'escriptura.",
        "read_only_mode_tooltip": "Desactivat mentre una altra instància de Termia tingui el bloqueig d'escriptura.",
        ...
        "keybindings_description": "Fes clic en una drecera i prem la combinació que vulguis. Usa Esborrar per deixar-la desactivada i que la combinació arribi al shell remot.",
        "keybinding_capture_prompt": "Prem la combinació",
        "keybinding_clear": "Esborrar",
    ...
    "en": {
        ...
        "split": "Split", "split_up": "Split up", "split_down": "Split down", "split_right": "Split right", "split_left": "Split left", "tab": "Tab", "close_tab": "Close tab", "disconnect": "Disconnect", "connecting": "Connecting",
        ...
        "read_only_mode_enabled": "This Termia instance is running in read-only mode because another instance already owns the write lock.",
        ...
        "keybindings_description": "Click a shortcut and press the combination you want. Use Clear to leave it disabled so the combination reaches the remote shell.",
