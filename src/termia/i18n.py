...
MESSAGES = {'servers': 'Show or hide server list',
 ...
 'audible_bell': 'Audible terminal bell',
 'local_prompt': 'Local prompt',
 'prompt_new_terminals_only': 'Prompt changes apply only to new local Bash terminals; running local shells and SSH sessions are left unchanged.',
 'terminal_preview': 'Shared preview',
 'terminal_preview_command': 'printf "Termia preview"',
 'terminal_preview_output': 'Termia preview output',
 ...
 'open_connection_in_split': 'Open connection in split…',
 'split_direction': 'Split direction',
 'connection': 'Connection',
 'search_connections': 'Search connections',
 'no_matching_connections': 'No matching connections.',
 'split_ssh_option': 'SSH · {name}',
 'split_local_option': 'Local · {name}',
 'split_connection_none_available': 'Create a saved SSH server or local terminal before opening a different connection in a split.',
 'split_pane_limit': 'A tab cannot contain more than {limit} terminal panes.',
 ...
 'hide_session_status_bar': 'Hide session status bar',
 ...
 'send_password_shortcut': 'Allow sending saved password with shortcut',
 'send_password_enter': 'Send saved password and press Enter',
 'send_password_sent': 'Saved password sent to the terminal',
 'send_password_unavailable': 'This terminal does not have a saved password',
 'send_files_to_server': 'Send files to server',
 'send_files_to_server_destination_title': 'Upload destination for {name}',
 'send_files_to_server_destination_label': 'Remote directory',
 'send_files_to_server_destination_confirm': 'Upload',
 'send_files_to_server_destination_invalid': 'Enter an absolute remote path without control characters or .. segments.',
 ...
 'send_files_to_server_prepare_remote': 'Checking remote destination...',
 'send_files_to_server_copying': 'Copying files...',
 'send_files_to_server_prepare_failed': 'The remote destination does not exist or is not accessible.',
 'send_files_to_server_copy_failed': 'SCP could not copy the selected files.',
 ...
 'send_files_to_server_password_title': 'SCP password required',
 'send_files_to_server_password_detail': 'Enter the password for {user}@{host}:',
 'send_files_to_server_password_confirm': 'Continue',
 'send_files_to_server_password_empty': 'Enter a password.',
 'send_files_to_server_auth_failed': 'SCP authentication failed.',
 ...
 'keybinding_action_filter_servers': 'Filter servers',
 'keybinding_action_toggle_sidebar': 'Show or hide server list',
 'keybinding_action_toggle_main_menu': 'Open or close main menu',
 'keybinding_action_new_local_terminal': 'Open new local terminal',
 'keybinding_action_focus_next_region': 'Focus next interface region',
 'keybinding_action_focus_previous_region': 'Focus previous interface region',
 'keybinding_action_focus_split_left': 'Focus split pane to the left',
 'keybinding_action_focus_split_right': 'Focus split pane to the right',
 'keybinding_action_focus_split_up': 'Focus split pane above',
 'keybinding_action_focus_split_down': 'Focus split pane below',
 ...
 'workspace_empty': 'Open at least one terminal tab before saving a workspace.',
 'workspace_saved': 'Workspace saved: {name}',
 'workspace_renamed': 'Workspace renamed: {name}',
 'workspace_updated': 'Workspace updated: {name}',
 'workspace_duplicated': 'Workspace duplicated: {name}',
 'workspace_deleted': 'Workspace deleted: {name}',
 'workspace_detail_info': '{tabs} tabs · {panes} panes',
 'open_workspace': 'Open workspace',
 'update_workspace': 'Update workspace with current tabs',
 'rename_workspace': 'Rename workspace',
 'duplicate_workspace': 'Duplicate workspace',
 'delete_workspace': 'Delete workspace',
 'delete_workspace_confirm': 'Delete workspace "{name}"? This action cannot be undone.',
 ...
 'workspace_pane_limit_exceeded': 'A workspace can contain at most {limit} panes; current layout has {count}.',
 'restore_sessions_title': 'Restore the previous Termia session?',
 'restore_sessions_detail': 'Termia found {count} open tab(s) from the previous run. Restore their saved connections and split layout? Terminal output and running processes are not restored.',
 'restore_sessions': 'Restore session',
 'skip_restore_sessions': 'Start fresh',
 'sessions_restored': 'Previous session restored: {count} tab(s)',
 'sessions_not_restored': 'Previous session was not restored.',
 'sessions_restored_with_skipped': 'Previous session restored: {count} tab(s); {skipped} unavailable tab(s) skipped.',
 'global_tab_limit_exceeded': 'Cannot open tabs: {open} already open, {requested} requested, global limit {limit}.',
 ...
 'history_result_interrupted': 'Interrupted',
 ...
 'clear_confirm': 'Delete all groups, servers, local terminals, and workspaces? This action cannot be undone.',
 'rename_tab': 'Rename tab',
 'duplicate_tab': 'Duplicate tab',
 'detach_tab': 'Move to new window',
 'reattach_tab': 'Reattach to main window',
