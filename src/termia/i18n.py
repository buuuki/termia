...
TRANSLATIONS = {
    "es": {
        ...
        "send_files_to_server": "Enviar ficheros al servidor",
        "send_files_to_server_title": "Subiendo a {name}",
        "send_files_to_server_started": "Transferencia iniciada a {name}",
        "send_files_to_server_running": "Subiendo a {name} en {destination}",
        "send_files_to_server_prepare_remote": "Preparando directorio remoto...",
        "send_files_to_server_copying": "Copiando ficheros...",
        "send_files_to_server_finished": "Ficheros enviados a {name}",
        "send_files_to_server_failed_generic": "No se pudo completar la transferencia.",
        "send_files_to_server_failed_detail": "No se pudo completar la transferencia: {error}",
        "send_files_to_server_cancelled": "Transferencia cancelada.",
        "send_files_to_server_start_failed": "No se pudo iniciar la transferencia: {error}",
        "send_files_to_server_missing": "No se encontró scp o ssh en el PATH.",
        "send_files_to_server_fingerprint": "Confirma la huella del host en la terminal si aparece y después introduce la contraseña si se pide.",
    ...
    "ca": {
        ...
        "send_files_to_server": "Enviar fitxers al servidor",
        "send_files_to_server_title": "Pujant a {name}",
        "send_files_to_server_started": "Transferència iniciada a {name}",
        "send_files_to_server_running": "Pujant a {name} a {destination}",
        "send_files_to_server_prepare_remote": "Preparant directori remot...",
        "send_files_to_server_copying": "Copiant fitxers...",
        "send_files_to_server_finished": "Fitxers enviats a {name}",
        "send_files_to_server_failed_generic": "No s'ha pogut completar la transferència.",
        "send_files_to_server_failed_detail": "No s'ha pogut completar la transferència: {error}",
        "send_files_to_server_cancelled": "Transferència cancel·lada.",
        "send_files_to_server_start_failed": "No s'ha pogut iniciar la transferència: {error}",
        "send_files_to_server_missing": "No s'ha trobat scp o ssh al PATH.",
        "send_files_to_server_fingerprint": "Confirma la petjada de l'host a la terminal si apareix i després introdueix la contrasenya si se't demana.",
    ...
    "en": {
        ...
        "send_files_to_server_fingerprint": "Confirm the host fingerprint in the terminal if prompted, then enter the password if needed.",
