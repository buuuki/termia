...
MESSAGES = {'servers': 'Show or hide server list',
 "update_title": "Termia updates",
 "update_check": "Check for updates",
 "update_current": "Current version: {version}",
 "update_intro": "Check official releases for a newer compatible version.",
 "update_notes": "Release notes",
 "update_install": "Download and install",
 "update_checking": "Checking for updates…",
 "update_available": "Version {version} is available.",
 "update_current_latest": "No newer compatible release is available.",
 "update_confirm": "Install Termia {version}? Debian installation may request administrator authentication. Once installation starts, let it finish. Restart Termia manually afterwards.",
 "update_preparing": "Downloading and verifying the update…",
 "update_applying": "Installing… Please wait for the installation to finish.",
 "update_installed": "Update installed. Restart Termia to use the new version.",
 "update_installed_source": "Source updated. Run scripts/termia-setup.sh install in the checkout to verify dependencies, then restart Termia.",
 "update_cancelling": "Cancelling…",
 "update_cancelled": "Update cancelled.",
 "update_busy": "Another update is in progress. Try again when it finishes.",
 "update_network_failed": "Could not contact the release server. Check your connection and try again later.",
 "update_untrusted": "Update verification failed. Nothing has been installed.",
 "update_failed": "The update could not be completed. Try checking again.",
 "update_install_failed": "Installation failed or authorization was cancelled. Check permissions, dependencies and package-manager availability before trying again.",
 "update_checkout_blocked": "Automatic installation is available only for a clean release checkout on main or a release tag. Development branches and local changes must be updated manually.",
 "update_no_verified_asset": "This release has no compatible Debian package with a SHA-256 digest. Use the release page for manual installation.",
 "update_installer_missing": "Automatic installation requires APT, dpkg and pkexec with a desktop authentication agent.",
 "update_unknown_installation": "This installation type cannot be updated automatically. Use the official release page.",
 'sftp_browse': "Browse files (SFTP)",
 'sftp_up': "Parent directory",
 ...
 'sftp_rename': "Rename",
 'sftp_delete': "Delete",
 'sftp_reconnect': "Reconnect SFTP",
 'sftp_reconnect_required': "Reconnect SFTP to continue.",
 'sftp_working': "Working…",
 'sftp_done': "Operation completed.",
 'sftp_trust': "Verify this fingerprint through a trusted channel before accepting. Save this host key?",
 'sftp_password': "SSH password or private-key passphrase (not saved)",
 'sftp_key_changed': "Host key changed. Connection refused; verify the server identity.",
 'sftp_cancelled': "Cancelled. Reconnect to continue. Partial remote files or directories may remain.",
 'sftp_failed': "SFTP operation failed. Check the connection, permissions and destination. Existing paths are never overwritten; partial files or directories may remain.",
 'sftp_invalid_name': "Enter a filename without path separators or control characters.",
 'sftp_delete_confirm': "Permanently delete the selected item? Only empty directories can be removed.",
 'sftp_select': "Select",
 'sftp_continue': "Continue",
 ...
 'send_password_shortcut_unavailable': 'Configure the "Send saved password" shortcut in Keybindings to enable this option.',
 'send_password_enter': 'Send saved password and press Enter',
 'send_password_enter_unavailable': 'Enable "Allow sending saved password with shortcut" first.',
 ...
 'snippet_manage_categories': 'Manage categories',
 'snippet_category_add': 'Add category',
 'snippet_category_rename': 'Rename category',
 'snippet_category_duplicate': 'Duplicate category',
 'snippet_category_delete': 'Delete category',
 'snippet_category_delete_confirm': 'Delete category "{name}"? Snippets in this category ({count}) will move to Uncategorized.',
 'snippet_category_exists': 'A category with this name already exists.',
 'snippet_category_missing': 'The selected category no longer exists.',
 'snippet_back_to_categories': 'All categories',
 'snippet_select_preview': 'Select a snippet to preview its command.',
 'snippet_preview_heading': 'Command preview',
 'snippet_category_count': '{count} snippets',
 'snippet_uncategorized': 'Uncategorized',
 'snippet_new_category': 'Create a new category',
 'snippet_new_category_name': 'New category name',
 'snippet_add': 'Add snippet',
 'snippet_create': 'Create snippet',
 'snippet_edit': 'Edit snippet',
 'snippet_duplicate': 'Duplicate snippet',
 'snippet_delete': 'Delete snippet',
 'snippet_action_edit': 'Edit',
 'snippet_action_duplicate': 'Duplicate',
 'snippet_action_delete': 'Delete',
 'snippet_delete_confirm': 'Delete snippet "{name}"? This action cannot be undone.',
 'snippet_category': 'Category',
 'snippet_category_required': 'A category name is required.',
 'snippet_scope': 'Availability',
 'snippet_scope_global': 'All terminals',
 'snippet_scope_group': 'Server group',
 'snippet_scope_server': 'Specific server',
 'snippet_content': 'Command',
 'snippet_copy_suffix': '(copy)',
 'search_snippets': 'Search snippets',
 'no_snippets': 'No matching snippets.',
 'snippet_variables': 'Snippet variables',
 'snippet_preview': 'Preview command',
 'snippet_preview_detail': 'Review the command before sending it to the selected terminal.',
 'send_snippet': 'Send to terminal',
 'snippet_sent': 'Snippet sent to terminal.',
 'snippet_name_required': 'A snippet name is required.',
 'snippet_content_required': 'A snippet command is required.',
 'snippet_scope_invalid': 'The snippet availability is invalid.',
 'snippet_scope_target_required': 'Select the server or group for this snippet.',
 'snippet_variable_required': 'Enter a value for every snippet variable.',
 'snippet_terminal_unavailable': 'The selected terminal is no longer available.'}
