...
can be disabled from General preferences. When enabled, they are flushed at most
every 30 seconds while typing, when sessions end, and when Termia closes. See
