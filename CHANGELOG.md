...
- Keep Debug output in Termia's state log instead of forwarding it to stderr/syslog, and show the visible log path notification when Debug mode is enabled.
