...
```bash
python3 -m py_compile run_termia.py src/termia/app.py src/termia/asbru_import.py src/termia/constants.py src/termia/i18n.py src/termia/models.py src/termia/stores.py src/termia/terminal_config.py src/termia/ui_state.py
